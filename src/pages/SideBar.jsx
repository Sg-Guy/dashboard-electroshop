...
import { LayoutDashboard, Package, Layers, LogOut, Database } from 'lucide-react';
...
const SideBar = ({ activePage }) => {
  return (
    <aside className="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col hidden lg:flex">
      <div className="p-6">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white">ElectroShop</h2>
      ...
      <div className="p-4 border-t border-slate-200 dark:border-slate-800">
        <button className="flex items-center gap-3 text-red-500 font-medium p-3 w-full hover:bg-red-50 dark:hover:bg-red-900/10 rounded-xl transition-all">
